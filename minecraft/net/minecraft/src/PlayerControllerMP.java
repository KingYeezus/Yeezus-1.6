...
import MEDMEX.Modules.Player.AntiDesync;
import MEDMEX.Modules.World.BoatPlace;
...
public class PlayerControllerMP
{
    ...
    public boolean onPlayerRightClick(EntityPlayer par1EntityPlayer, World par2World, ItemStack par3ItemStack, int par4, int par5, int par6, int par7, Vec3 par8Vec3)
    {
        ...
        if(!BoatPlace.instance.isEnabled() || mc.thePlayer.getHeldItem() == null || !(mc.thePlayer.getHeldItem().getItem() instanceof ItemBoat))
